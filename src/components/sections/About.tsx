...
import { skills, educationData, certifications } from "../../lib/data";
import {
  Code,
  Server,
  Palette,
...
const About: React.FC = () => {
  ...
  return (
    <section className="min-h-full w-full px-3 sm:px-6 py-8 sm:py-10 md:py-16 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-12 mb-10 sm:mb-16">
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 leading-relaxed">
                I am currently pursuing my studies at Universitas Negeri Padang,
                majoring in Educational Technology Informatics. This academic
                path allows me to blend my technical skills with a passion for
